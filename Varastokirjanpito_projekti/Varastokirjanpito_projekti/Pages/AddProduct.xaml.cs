    ...
    private async void ProductAdded(object sender, EventArgs e)
    {
        ...
        var data = new Books
        {
            ...
            try
            {
                ...
                await _apiService.LogDeletionAsync(_user.Username, $"{Author.Text}: {Title.Text}", $"Lis‰tty, {timestamp}", AdditionalInfo.Text);
            ...
            {
                await DisplayAlert("Error", $"Tallennus ep‰onnistui: {ex.Message}", "OK");
            }
        }
        catch
        {
